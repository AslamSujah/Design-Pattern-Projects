...
public class Car {
    ...
    static class Builder{
        ...
        public Builder etcMethod(Boolean etc){
            this.etc = etc;
            return this;
        }

        public Builder roadAssistanceMethod(String roadAssistance){
            this.roadAssistance = roadAssistance;
            return this;
        }

        public Builder dropOffLocationMethod(String dropOffLocation){
